import { Popover, PopoverTrigger, Input, Portal, PopoverContent, Flex } from "@chakra-ui/react"
import { PanelBar, PanelBarMiddle, PanelBarEnd } from "@components/panels/panel"
      ...
      >
        <PopoverTrigger>
          <Input
            ...
            value={fileId ? fileMetadata.filename : 'Choose file from side menu'}
