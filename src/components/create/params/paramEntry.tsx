...
import {
  chakra, IconButton, Input
} from "@chakra-ui/react";
import { projectParamsAtom } from "core/recoil/atoms/project";
import { ConstructableType } from "core/types";
    ...
    >
      <Flex minW="50%" justifyContent="space-between" px="0.5rem">
        ...
        <chakra.select
          ...
          onChange={(ev) => {
            ...
            setParam((old) => ({
              ...old,
              paramType,
              param: paramDefaultValues[paramType],
              interface: 0,
            }));
          }}
          bg="none"
        ...
        >
          ...
          <option value="float" style={optionStyle}>
            float
          </option>
          <option value="color" style={optionStyle}>
            color
          </option>
          <option value="vec2f" style={optionStyle}>
            vec2f
          </option>
          <option value="vec3f" style={optionStyle}>
            vec3f
          </option>
          <option value="vec2i" style={optionStyle}>
            vec2i
          </option>
          <option value="vec3i" style={optionStyle}>
            vec3i
          </option>
        </chakra.select>
      </Flex>
