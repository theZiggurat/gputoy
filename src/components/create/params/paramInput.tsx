...
const ValueInput = (
  ...
  return (
    ...
    >
      ...
      >
        <NumberInputField
          _hover={{ bg: "none", borderColor: "red.500" }}
          paddingInline="0"
          border="0px"
        />
      </NumberInput>
  ...
  return (
    <>
      <ValueInput
        ...
        precision={4}
        onValueChange={(num) =>
          props.onChange([num, props.value[1], props.value[2]])
        }
        label="x"
      />
      <ValueInput
        ...
        precision={4}
        onValueChange={(num) =>
          props.onChange([props.value[0], num, props.value[2]])
        }
        label="y"
      />
      <ValueInput
        ...
        precision={4}
        onValueChange={(num) =>
          props.onChange([props.value[0], props.value[1], num])
        }
        label="z"
      />
    </>
  ...
  return (
    <>
      <ValueInput
        ...
        precision={0}
        onValueChange={(num) =>
          props.onChange([num, props.value[1], props.value[2], props.value[3]])
        }
        label="r"
      />
      <ValueInput
        ...
        precision={0}
        onValueChange={(num) =>
          props.onChange([props.value[0], num, props.value[2], props.value[3]])
        }
        label="g"
      />
      <ValueInput
        ...
        precision={0}
        onValueChange={(num) =>
          props.onChange([props.value[0], props.value[1], num, props.value[3]])
        }
        label="b"
      />
      <ValueInput
        ...
        precision={0}
        onValueChange={(num) =>
          props.onChange([props.value[0], props.value[1], props.value[2], num])
        }
        label="a"
      />
    </>
