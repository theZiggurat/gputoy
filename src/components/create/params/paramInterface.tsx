...
import {
    FloatInterfaceKnob,
    IntInterfaceKnob
} from "./interface/floatInterface";
import {
    Vec2InterfaceCartesian,
    Vec2InterfaceRadial
} from "./interface/vec2Interface";
...
export const ParamInterface = (
  props: { selectedParam: string | null } & BoxProps
) => {
  ...
  return (
    ...
    >
      {paramInterface &&
        props.selectedParam &&
        React.createElement(paramInterface, {
          paramKey: param.key,
          value: param.param,
...
export const useInterfaceProps = (props: {
  paramKey: string;
}): [
  any,
  ...
  const [interfaceProps, setInterfaceProps] = useRecoilState(
    projectParamInterfaceProps(props.paramKey)
  );
