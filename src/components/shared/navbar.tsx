import {
    Badge, Box, Button,
    chakra,
    Flex, HStack, IconButton, Text, useColorMode, useColorModeValue, useMediaQuery
    ...
    >
      {!isMobile && (
        <>
          ...
          <chakra.ul listStyleType="none" display="inline-block" mx="4rem">
          ...
          */}
          ...
          <Box>
            <IconButton {...nightButtonProps} onClick={toggleColorMode} />
          </Box>
        </>
      )}
      {isMobile && (
